...
N0W155_temp$air_temp[N0W155_temp$air_temp=="-9.999"]<-NA
...
#draw plot
par(mfrow=c(2,2))
ggplot(sea,mapping = aes(x =year, y=sea_surface_temperature))+geom_point() +
  geom_smooth(method = 'loess')
ggplot(air,mapping = aes(x=year, y=air_temperature)) + geom_point() +
  geom_smooth(method = 'loess')
```
# table
...
N8E165_temp$air_temp[N8E165_temp$air_temp=="-9.999"]<-NA
...
S8E165_temp$air_temp[S8E165_temp$air_temp=="-9.999"]<-NA
...
N8W110_temp$air_temp[N8W110_temp$air_temp=="-9.999"]<-NA
...
S8W110_temp$air_temp[S8W110_temp$air_temp=="-9.999"]<-NA
S8W110_temp<-na.omit(S8W110_temp)
```

```{r}
temp <- rbind(N0W155_temp, N8E165_temp,S8E165_temp,N8W110_temp,S8W110_temp)
write.csv(temp, "team14_data.csv")

```

## Mapping selected buoys
```{r}
library(ggmap)
library(ggplot2)
