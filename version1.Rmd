...
W155_temp $Lon <-"155W"
# Reorder the clumns
W155_temp<-W155_temp[,c('team_num','reading_type','date_time','time_diff','Lat','Lon','sea_temp','air_temp')]

# Add hours to date_time
W155_temp$hour <- ("12:00")
W155_temp$date_time <- paste(W155_temp$date_time, W155_temp$hour, sep = " ")
W155_temp <- W155_temp[, -9]
```
